...
use crate::SimState;
use crate::body::{RotationSpeed, Radius, Star, Moon, Planet, BodyChildren};
...
fn rotate_bodies(
    mut planet_query: Query<(&RotationSpeed, &mut Transform, &Radius, With<Planet>, Without<Star>, Without<Moon>)>,
    time: Res<Time>,
    speed: Res<Speed>,
    pause: Res<Pause>
) {     
